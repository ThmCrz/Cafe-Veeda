...
import Gcash from '../../assets/images/Gcash icon.png'
import Paymaya from '../../assets/images/Paymaya icon.png'
              ...
              <section className="bg-white rounded-xl  p-5 lg:p-7 space-y-3">
                <div className="flex gap-2 items-center">
                  ...
                  >
                    ...
                    <img src={Gcash} alt="Gcash" height={40} width={40}/>
                    GCASH
                  </label>
                </div>
                <hr />
                <div className="flex gap-2 items-center">
                  ...
                  >
                    ...
                    <img src={Paymaya} alt="Maya" height={40} width={40}/>
                    PAYMAYA
                  </label>
                </div>
                <hr />
