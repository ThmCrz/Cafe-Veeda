...
import kape1 from '../assets/images/kape 1.jpg'
import kape2 from '../assets/images/kape 2.jpg'
import kape3 from '../assets/images/kape 3.jpg'
// assets images
...
class Mainpage extends Component {
  state = {
    provide: [
      ...
      "Free member card with a minimum purchase of PHP 200",
    ],
    reviews: [
      {
        name: "Foo Barr",
